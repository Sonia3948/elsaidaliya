      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="relative">
            <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 bg-pharmacy-light rounded-full p-3 border-4 border-white shadow-md px-0 py-0">
              <Award size={30} className="text-pharmacy-dark mx-0 my-0 py-0 px-0  bg-transparent" />
            </div>
