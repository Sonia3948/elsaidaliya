...
const Index = () => {
  return (
    <Layout>
      <section className="bg-gradient-to-b from-medical-light to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20">
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Link to="/register">
                <Button size="lg" className="bg-medical hover:bg-medical-dark">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-6 rounded-lg border border-gray-100 shadow-sm">
              <div className="h-12 w-12 bg-medical-light rounded-full flex items-center justify-center mx-auto mb-4">
                <span className="text-medical-dark font-bold text-xl">1</span>
              </div>
            ...
            <div className="text-center p-6 rounded-lg border border-gray-100 shadow-sm">
              <div className="h-12 w-12 bg-medical-light rounded-full flex items-center justify-center mx-auto mb-4">
                <span className="text-medical-dark font-bold text-xl">2</span>
              </div>
            ...
            <div className="text-center p-6 rounded-lg border border-gray-100 shadow-sm">
              <div className="h-12 w-12 bg-medical-light rounded-full flex items-center justify-center mx-auto mb-4">
                <span className="text-medical-dark font-bold text-xl">3</span>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Med-Supply-Link est conçu pour faciliter les connexions entre les acteurs du secteur pharmaceutique.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
              <h3 className="text-xl font-semibold mb-4 text-medical-dark">Pour les pharmaciens</h3>
              <ul className="space-y-3">
                <li className="flex items-start">
                  <div className="flex-shrink-0 h-5 w-5 rounded-full bg-medical-light flex items-center justify-center mt-1">
                    <span className="text-medical-dark font-bold text-xs">✓</span>
                  </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
              <h3 className="text-xl font-semibold mb-4 text-medical-dark">Pour les fournisseurs</h3>
              <ul className="space-y-3">
                <li className="flex items-start">
                  <div className="flex-shrink-0 h-5 w-5 rounded-full bg-medical-light flex items-center justify-center mt-1">
                    <span className="text-medical-dark font-bold text-xs">✓</span>
      ...
      <section className="py-12 md:py-20 bg-medical-dark text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold mb-6">Prêt à rejoindre Med-Supply-Link ?</h2>
          <p className="text-lg mb-8 max-w-2xl mx-auto">
            Inscrivez-vous aujourd'hui et commencez à optimiser votre chaîne d'approvisionnement pharmaceutique.
          </p>
          <Link to="/register">
            <Button size="lg" className="bg-white text-medical-dark hover:bg-gray-100">
