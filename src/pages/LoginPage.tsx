            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="text-sm">
                  <Link to="#" className="font-medium text-medical hover:text-medical-dark">
                    Mot de passe oublié ?
                  </Link>
                </div>
              </div>
              ...
              <div>
                <Button type="submit" disabled={isLoading} className="w-full bg-medical hover:bg-medical-dark bg-pharmacy-accent">
