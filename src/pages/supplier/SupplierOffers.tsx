          ...
          <CardContent>
            <div className="space-y-4">
              <div>
                ...
                <Input id="offerTitle" value={offerTitle} onChange={e => setOfferTitle(e.target.value)} placeholder="Ex: Promotion sur antibiotiques" />
              </div>
              ...
              <div>
                ...
                <Textarea id="offerText" value={offerText} onChange={e => setOfferText(e.target.value)} placeholder="Décrivez votre offre en détail..." rows={4} />
              </div>
              ...
              <div>
                ...
                <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 flex flex-col items-center justify-center bg-gray-50">
                  ...
                  <Input id="offerImage" type="file" accept="image/*" onChange={handleImageChange} className="max-w-xs" />
                </div>
                
                {previewUrl && <div className="mt-4">
                    <p className="text-sm font-medium text-gray-700 mb-2">Aperçu:</p>
                    <img src={previewUrl} alt="Aperçu de l'offre" className="max-h-40 rounded-md" />
                  </div>}
              </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {offers.map(offer => <div key={offer.id} className="border rounded-lg overflow-hidden">
